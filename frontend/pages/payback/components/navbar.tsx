...
const home = "/payback"
const pages = [{ name: 'Kunde werden', link: `${home}/kunde` }, { name: 'Partner werden', link: 'https://www.payback.group/de/partner' }, { name: 'Konto Übersicht', link: `${home}/kontoUebersicht` }];
